...
import dbz.utils.ReflectionUtils.PackageType;
 ...
 * @version 1.7
 */
public enum ParticleEffectsHandler {
	/**
	...
	private static final Map<String, ParticleEffectsHandler> NAME_MAP = new HashMap<String, ParticleEffectsHandler>();
	private static final Map<Integer, ParticleEffectsHandler> ID_MAP = new HashMap<Integer, ParticleEffectsHandler>();
	...
	static {
		for (ParticleEffectsHandler effect : values()) {
	 ...
	 */
	private ParticleEffectsHandler(String name, int id, int requiredVersion, ParticleProperty... properties) {
		this.name = name;
		this.id = id;
	 ...
	 */
	public static ParticleEffectsHandler fromName(String name) {
		for (Entry<String, ParticleEffectsHandler> entry : NAME_MAP.entrySet()) {
	 ...
	 * @return The particle effect
	 */
	public static ParticleEffectsHandler fromId(int id) {
		for (Entry<Integer, ParticleEffectsHandler> entry : ID_MAP.entrySet()) {
			if (entry.getKey() != id) {
				continue;
			}
			return entry.getValue();
	 ...
	 */
	private static boolean isDataCorrect(ParticleEffectsHandler effect, ParticleData data) {
	 ...
	 */
	private static boolean isColorCorrect(ParticleEffectsHandler effect, ParticleColor color) {
	 ...
	 * @see ParticlePacket#ParticlePacket(ParticleEffectsHandler, Vector, float, boolean, ParticleData)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	 ...
	 * @see ParticlePacket#ParticlePacket(ParticleEffectsHandler, ParticleColor, boolean)
	 * @see ParticlePacket#sendTo(Location, double)
	 */
	...
	/**
	 * Represents the particle data for effects like {@link ParticleEffectsHandler#ITEM_CRACK}, {@link ParticleEffectsHandler#BLOCK_CRACK} and {@link ParticleEffectsHandler#BLOCK_DUST}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the item data for the {@link ParticleEffectsHandler#ITEM_CRACK} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the block data for the {@link ParticleEffectsHandler#BLOCK_CRACK} and {@link ParticleEffectsHandler#BLOCK_DUST} effects
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link ParticleEffectsHandler#SPELL_MOB}, {@link ParticleEffectsHandler#SPELL_MOB_AMBIENT}, {@link ParticleEffectsHandler#REDSTONE} and {@link ParticleEffectsHandler#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for effects like {@link ParticleEffectsHandler#SPELL_MOB}, {@link ParticleEffectsHandler#SPELL_MOB_AMBIENT} and {@link ParticleEffectsHandler#NOTE}
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	/**
	 * Represents the color for the {@link ParticleEffectsHandler#NOTE} effect
	 * <p>
	 * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
	 * 
	 * @author DarkBlade12
	...
	public static final class ParticlePacket {
		...
		private final ParticleEffectsHandler effect;
		 ...
		 * @see #initialize()
		 */
		public ParticlePacket(ParticleEffectsHandler effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
		 ...
		 * @see #ParticleEffect(ParticleEffectsHandler, float, float, float, float, int, boolean, ParticleData)
		 */
		public ParticlePacket(ParticleEffectsHandler effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
		 ...
		 * @see #ParticleEffect(ParticleEffectsHandler, float, float, float, float, int, boolean, ParticleData)
		 */
		public ParticlePacket(ParticleEffectsHandler effect, ParticleColor color, boolean longDistance) {
			this(effect, color.getValueX(), color.getValueY(), color.getValueZ(), 1, 0, longDistance, null);
			if (effect == ParticleEffectsHandler.REDSTONE && color instanceof OrdinaryColor && ((OrdinaryColor) color).getRed() == 0) {
			...
			try {
				...
				if (version < 8) {
					...
					if (data != null) {
						...
						ReflectionUtils.setValue(packet, true, "k", effect == ParticleEffectsHandler.ITEM_CRACK ? packetData : new int[] { packetData[0] | (packetData[1] << 12) });
					}
				}
